...
public class RecipeCommand implements Callable<Integer> {
    ...
    /**
     * Shows available recipes when called without a subcommand.
     *
     * @return exit code 0
    ...
    public static class SiteLaunchRecipe implements Callable<Integer> {
        ...
        /**
         * Executes the site launch recipe.
         *
         * @return exit code 0
         * @throws Exception if operation fails
         */
        ...
        public Integer call() throws Exception {
            ...
            if (CliFlags.mockMode || CliFlags.dryRunMode) {
                ...
                if (CliFlags.jsonOutput) {
                    System.out.println(
                        "{\"recipe\":\"site-launch\",\"steps\":5,\"status\":\"simulated\"}");
                }
                return 0;
            }
    ...
    public static class ContentBackupRecipe implements Callable<Integer> {
        ...
        /**
         * Executes the content backup recipe.
         *
         * @return exit code 0
         * @throws Exception if operation fails
         */
        ...
        public Integer call() throws Exception {
            ...
            if (CliFlags.mockMode || CliFlags.dryRunMode) {
                ...
                if (includeCf) {
                    System.out.println("  2. Export content fragments to JSON");
                }
                if (includeAssets) {
                    System.out.println("  3. Download assets");
                }
                System.out.println("  4. Create backup manifest");
                System.out.println("  5. Save to " + outputDir);

                if (CliFlags.jsonOutput) {
                    System.out.println("{\"recipe\":\"content-backup\",\"path\":\""
            ...
            if (includeCf) {
                System.out.println("  [2/4] Exporting content fragments...");
            }
            if (includeAssets) {
                System.out.println("  [3/4] Downloading assets...");
            }
    ...
    public static class AssetBatchRecipe implements Callable<Integer> {
        ...
        /**
         * Executes the asset batch recipe.
         *
         * @return exit code 0
         * @throws Exception if operation fails
         */
        ...
        public Integer call() throws Exception {
            ...
            if (CliFlags.mockMode || CliFlags.dryRunMode) {
                ...
                if (tags != null) {
                    System.out.println("  3. Apply tags: " + tags);
                }
                if (metadataFile != null) {
                    System.out.println("  4. Apply metadata from " + metadataFile);
                }
                if (publish) {
                    System.out.println("  5. Publish assets to delivery");
                }

                if (CliFlags.jsonOutput) {
                    System.out.println("{\"recipe\":\"asset-batch\",\"path\":\""
                        + path + "\",\"status\":\"simulated\"}");
                }
                return 0;
            }
            ...
            if (tags != null) {
                System.out.println("  [" + (step++) + "/5] Applying tags...");
            }
            if (metadataFile != null) {
                System.out.println("  [" + (step++) + "/5] Applying metadata...");
            }
            if (publish) {
                System.out.println("  [" + step + "/5] Publishing...");
            }
    ...
    public static class UserOnboardingRecipe implements Callable<Integer> {
        ...
        /**
         * Executes the user onboarding recipe.
         *
         * @return exit code 0
         * @throws Exception if operation fails
         */
        ...
        public Integer call() throws Exception {
            ...
            if (CliFlags.mockMode || CliFlags.dryRunMode) {
                ...
                if (notify && email != null) {
                    System.out.println("  5. Send welcome email to " + email);
                }

                if (CliFlags.jsonOutput) {
                    System.out.println("{\"recipe\":\"user-onboard\",\"user\":\""
                        + userId + "\",\"status\":\"simulated\"}");
                }
                return 0;
            }
    ...
    public static class PackageMigrateRecipe implements Callable<Integer> {
        ...
        /**
         * Executes the package migration recipe.
         *
         * @return exit code 0
         * @throws Exception if operation fails
         */
        ...
        public Integer call() throws Exception {
            ...
            if (CliFlags.mockMode || CliFlags.dryRunMode) {
                ...
                if (install) {
                    System.out.println("  5. Install package");
                }

                if (CliFlags.jsonOutput) {
                    System.out.println("{\"recipe\":\"package-migrate\",\"package\":\""
                        + group + ":" + name + "\",\"status\":\"simulated\"}");
                }
                return 0;
            }
