...
public class AemAgent {
    ...
    private String envUrl() {
        try {
            return com.aemtools.aem.config.ConfigManager.getInstance().getActiveEnvironmentUrl();
        } catch (Exception e) {
    ...
    private String executeListFragments(JsonNode params) throws IOException {
        ...
        com.aemtools.aem.api.ContentFragmentApi cfApi = new com.aemtools.aem.api.ContentFragmentApi(apiClient);
    ...
    private String executeListPages(JsonNode params) throws IOException {
        ...
        com.aemtools.aem.api.PagesApi pagesApi = new com.aemtools.aem.api.PagesApi(apiClient);
    ...
    private String executeGraphQL(JsonNode params) throws IOException {
        ...
        com.aemtools.aem.api.GraphQLApi graphqlApi = new com.aemtools.aem.api.GraphQLApi(apiClient);
